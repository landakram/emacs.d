...
#+BEGIN_SRC emacs-lisp
  (use-package helm
    ...
    (customize-set-variable helm-completion-style 'helm)
    (add-to-list 'completion-styles 'helm)
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-minor-mode write-mode
    ...
    ;; Still doesn't operate per-buffer like I want
    ;; because perect-margin-mode is a global minor mode
    (if (bound-and-true-p write-mode)
      ...
      (progn
          ...
          (diminish-undo 'perfect-margin-mode)
...
#+BEGIN_SRC emacs-lisp 
  ...
  (defun helm-org-rifle--store-link (candidate)
  ...
  (defun helm-org-rifle--insert-link (candidate)
    ...
    (interactive)
    (helm-org-rifle--store-link candidate)
    (call-interactively 'org-insert-link))

  (defun org-rifle-insert-link ()
    (interactive)
    (add-to-list 'helm-org-rifle-actions '("Insert link" . helm-org-rifle--insert-link))
  ...
  (use-package helm-org-rifle
    ...
    (leader-def :infix "o"
      "l" 'org-rifle-insert-link)

    (general-define-key
     :keymaps 'org-mode-map
     :prefix "C-c"
     "C-." 'org-rifle-insert-link))
#+END_SRC
  ...
  (setq org-capture-templates
        '(("n" "Note" entry (file+headline "~/org/inbox.org" "Notes")
          ...
          ("c" "Calendar" entry (file+headline "~/org/calendar.org" "Calendar")
           "* %?\n")
          ("t" "Test" entry (file+headline "~/org/test.org" (format-time-string "%Y-%m-%d") "%?")
           "* %?\n")
